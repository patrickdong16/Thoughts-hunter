...
| 优先级 | 来源类型 | 说明 | MCP工具 |
|--------|----------|------|---------|
| **0** | 思想领袖 | 高优先级领袖新发布 | `/api/automation/leaders/pending` |
...
> 🆕 **v3.3 新增**：每条内容必须包含完整的来源信息，支持用户验证真实性

| 字段 | 必填 | 说明 | 示例 |
|------|------|------|------|
| `source` | ✅ | 发布场合、活动名称 + 时间 | `Davos WEF 2026 主题演讲, 2026年1月23日` |
| `source_url` | ✅ | 可访问的原文/视频链接 | `https://youtube.com/watch?v=xxx` |

**source 格式模板**：`[活动/平台名称] [类型], [日期]`
